...
Route::get('/product/{product_id}', [ProductController::class, 'open_product'])->name('OpenProduct')->middleware([IsBan::class, 'auth']);
...
Route::get('/admin/delete/{product_id}', [AdminController::class, 'delete_product'])->name('DeletePosition')->middleware(IsAdmin::class);
Route::get('/admin/ban/{user_id}', [AdminController::class, 'ban_user'])->name('BanUser')->middleware(IsAdmin::class);
Route::post('/search', [HomeController::class, 'search'])->name('Search')->middleware([IsBan::class, 'auth']);
